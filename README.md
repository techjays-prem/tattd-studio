...
| Drift detection — committed baselines under `evals/results/history/baselines.toml` + daily scheduled CI gate at `.github/workflows/drift.yml` | T3 stretch | [`drift_latest.md`](./evals/results/drift_latest.md) |
